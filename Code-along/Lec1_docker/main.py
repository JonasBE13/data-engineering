...
app.layout = Div(
    [
        H1("Dice simulator"),
        P("Choose number of dices and number of rows and enjoy the resulsts"),
        H2("Number of rolls"),
...
@app.callback(Output("dice-graph", "figure"), Input("number of rolls", "value"), Input("number-dices", "value"))
