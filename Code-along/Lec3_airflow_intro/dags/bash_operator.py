...
# [1] hoppar till dags parent folder, vilket är Lec3_airflow_intro
...
with DAG(dag_id ="joke_DAG", start_date=datetime(2023,8,16)):
    # vi har skapat en say_hello path
    say_hello = BashOperator(task_id = "say_hello",
    bash_command="echo 'hej hej joking time'")
    # setup_folders path
